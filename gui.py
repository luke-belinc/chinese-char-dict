...
class MainWindow(QWidget):
    ...
    def __init__(self, chartable):
        ...
        self.def_str = QPlainTextEdit()
        self.def_str.setReadOnly(True)
        self.def_str.setPlainText("")
        self.def_str.setWordWrapMode(QTextOption.WordWrap)
        self.definition_f_layout = QFormLayout()
        self.definition_f_layout.setRowWrapPolicy(QFormLayout.WrapLongRows)
        self.definition_f_layout.addRow("Definition:", self.def_str)
        self.definition_f_layout.setAlignment(Qt.AlignCenter)
        ...
        self.pinyin_f_layout.setAlignment(Qt.AlignCenter)
        ...
        self.g_layout.addWidget(self.search_button, 1, 0, 1, 1)
        self.g_layout.addWidget(self.replay_button, 1, 1, 1, 1)
        self.g_layout.addWidget(self.svg_viewer, 2, 0, 1, 2)
        self.g_layout.addLayout(self.pinyin_f_layout, 3, 0, 1, 2)
        self.g_layout.addLayout(self.definition_f_layout, 6, 0, 3, 2)
    ...
    def get_data(self, char):
        ...
        self.def_str.setPlainText(data[0])
